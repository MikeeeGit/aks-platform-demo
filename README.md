...
For Azure, the [short pipeline run list](https://github.com/MikeeeGit/terraform-delivery-templates/blob/main/docs/azure/quick-runbook.md) gives the deployment, standby update, WAF switch/rollback and teardown actions. The [dated qualification record](https://github.com/MikeeeGit/terraform-delivery-templates/blob/main/docs/azure/qualification-2026-09-21.md) records the actual direct-delivery Azure trial and its limits.
